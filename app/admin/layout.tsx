        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[var(--line)] bg-[rgba(10,10,10,0.8)] px-5 backdrop-blur-xl md:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5">
              <span className="h-8 w-8 rounded-full bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&q=70&auto=format&fit=crop')" }} />
              <div className="hidden text-[0.82rem] sm:block">
                <div className="font-medium leading-tight">Alejandro</div>
                <div className="text-[0.7rem] text-mist-2">Administrador</div>
              </div>
            </div>
          </div>
        </header>
